...
\rightheader{
  ...
  \makefield{\faGlobe}{\href{http://emilyldolson.com}{emilyldolson.com}} \\
  \makefield{\faMapMarker }{\texttt{Computer Science \& Engineering, 428 S. Shaw Ln.,\\Engineering Building, East Lansing, MI, 48824}}\\
...
\vspace{-0.25cm}
\makerubric{synergy}
\prefixmarker{\relscale{.9}\faRocket}
\vspace{-0.25cm}
\makerubric{mentees}
% \makerubric{skills}
% \makerubric{misc}
